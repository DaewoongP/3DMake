...
HRESULT ComponentManager::AddPrototype(_uint _levelIndex, const std::wstring& _prototypeTag, std::shared_ptr<Component> _prototype)
{
    ...
    NULL_CHECK_RETURN_MSG(!prototype, E_FAIL, TEXT("Engine::ComponentManager::CloneComponent\n Existing prototype"))
...
{
    std::shared_ptr<Component> prototype = Find_Prototype(_levelIndex, _prototypeTag);
    NULL_CHECK_RETURN_MSG(prototype, std::shared_ptr<Component>(), TEXT("Engine::ComponentManager::CloneComponent\n Can't Find Component"))
